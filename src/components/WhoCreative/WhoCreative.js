...
class WhoCreative extends Component {
    state = {
        mouseWheelDirection: ''
    }
    ...
    renderRedirect = () => {
        if ( this.state.redirect && this.state.mouseWheelDirection === 'up' ) return <Redirect to='/whatpreloaderCreative' />
    }
    ...
    render() {
        return (
            ...
            >
                ...
                <BgTextEtal/>
                <Social/>
                <Pagination activePage={3} page="creative"/>
